...
#.................. Tracker Functions .................
'''Compute Color for every box and track'''
...
def detect(weights=ROOT / 'yolov5n.pt',
        ...
        data=ROOT / 'yolov5/data/custom.yaml',  
        imgsz=(640, 640),conf_thres=0.65,iou_thres=0.55,  
        ...
        hide_conf=False,half=False,dnn=False,display_labels=True,
    ...
    half &= (pt or jit or onnx or engine) and device.type != 'gpu'  
    if pt or jit:
